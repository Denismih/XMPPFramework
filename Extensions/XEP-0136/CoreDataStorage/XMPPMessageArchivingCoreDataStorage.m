...
//        }
    ...
    [self scheduleBlock:^{
        ...
        if (!messageJid) {
            NSString *jidString = isOutgoing ? [message toStr] : [message fromStr];
            NSString *cuttedJidString = [jidString stringByReplacingOccurrencesOfString:@"/" withString:@""];
            messageJid = [XMPPJID jidWithString:cuttedJidString];
        }
...
//            {
                ...
                BOOL didCreateNewArchivedMessage = YES;
//            }
